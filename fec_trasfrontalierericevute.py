...
## V. 2.2 -  ricevute Transfrontaliere Intermediari e Diretto e Studio Associato
...
# r = s.get('https://ivaservizi.agenziaentrate.gov.it/ser/api/monitoraggio/v1/monitoraggio/fatture/?v='+unixTime()+'&idFiscCedente=&idFiscDestinatario=&idFiscEmittente=&idFiscTrasmittente=&idSdi=&perPage=10&start=1&statoFile=&tipoFattura=RICEVUTA')
print('Scarico il json delle fatture Ricevute TRAN per la Partita IVA ' + cfcliente)
...
print('Inizio a scaricare le fatture ricevute trans')
path = r'FattureRicevuteTRAN_' + cfcliente
...
print('Totale fatture Ricevute TRAN scaricate: ', numero_fatture)
print('Totale notifiche scaricate: ', numero_notifiche)
sys.exit()
